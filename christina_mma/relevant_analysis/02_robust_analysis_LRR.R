...
# Script based on Christina Raw's NHM_MMA/Scripts/28. Model_diagnostic_with_influence.ME_and_Robust_analysis.Rmd
...
#   3. Test influential data with influence.ME, Cook's distance, and sigtest
#   4. Run robust models
#   5. Save Bayesian and Robust models
