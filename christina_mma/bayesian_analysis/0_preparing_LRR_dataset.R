...
# Outputs: 06.Excel_Dataset_to_model_LRR_WIDE.xlsx 
#          07.Excel_Dataset_to_model_LRR_LONG.xlsx

# This script will prepare the dataset for Bayesian modelling 
...
wide_LRR <- d # wide_LRR format dataframe will be saved at the end 
...
# 11. Save wide and long format dataframes

write_xlsx(wide_LRR, "../output_files/06.Excel_Dataset_to_model_LRR_WIDE.xlsx")
