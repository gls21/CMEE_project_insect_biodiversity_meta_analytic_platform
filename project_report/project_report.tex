...
\usepackage[  % use to alter citation and referencing style 
backend=bibtex,
style=authoryear, 
sortcites=ynt, % sort in text citations in chronologial order
sorting=nyt % sort references alphabetically
]{biblatex}
\addbibresource{projectreportbibliography.bib}
